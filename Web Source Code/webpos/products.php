                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type == 'admin') {
                                        ...
                                        echo "<a class='btn btn-primary'  href=\"edit_product.php?id=" . $row['product_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_product.php?id=" . $row['product_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
        ...
        $("#example1").DataTable({
            ...
            buttons: [
...

                {
                    ...
                    title: '<p align="center">All Products</p>',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5, 6]
                    }
                },
