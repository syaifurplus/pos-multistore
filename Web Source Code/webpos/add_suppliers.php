...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM suppliers where suppliers_email='$suppliers_email' OR suppliers_cell='$suppliers_phone' AND owner_id='$owner_id'");
    ...
    if ($num_rows > 0) {
        ...
        if (mysqli_query($con, "INSERT INTO suppliers (`suppliers_name`,`suppliers_contact_person`,`suppliers_email`,`suppliers_cell`,`suppliers_address`,`shop_id`,`owner_id`) VALUE ('$suppliers_name','$suppliers_contact_person','$suppliers_email','$suppliers_phone','$suppliers_address','$shop_id','$owner_id')")) {
            echo '<script type="text/javascript">';
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="add_suppliers.php">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="suppliers_name" class="form-control"
                                           id="exampleInputsuppliersName"
                                           placeholder="Enter suppliers Name">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputsuppliersContactPerson">Suppliers Contact Person
                                        Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="suppliers_email" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="suppliers_address" class="form-control"
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" id="add_suppliers" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Add
                                    suppliers
                                </button>
                            </div>
                        </form>
