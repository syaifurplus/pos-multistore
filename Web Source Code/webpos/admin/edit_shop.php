...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = mysqli_query($con, "Update shop SET shop_name='$shop_name',shop_email='$shop_email',shop_contact='$shop_contact',shop_address='$shop_address',currency_symbol='$currency_symbol',shop_status='$shop_status' WHERE shop_id='$shop_id'");
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_shop.php">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_shop" class="btn btn-primary"><i
