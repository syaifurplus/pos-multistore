...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  if (!empty($getid)) {
    ...
    $query = mysqli_query($con, "SELECT * FROM admin WHERE admin_email='$getid'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = mysqli_query($con, "Update admin SET admin_name='$admin_name',admin_email='$admin_email',admin_cell='$admin_phone',admin_password='$admin_password' WHERE admin_id='$admin_id'");
  ...
  if ($sql) {
    ...
    echo '<script type="text/javascript">';
    echo "setTimeout(function () { window.open('edit_admin.php','_self')";
    echo '}, 1500);</script>';
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="edit_admin.php" class="nav-link active">
            ...
            <form role="form" id="quickForm" method="post" action="edit_admin.php">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="admin_password" class="form-control" id="exampleInputAddress" minlength="4"
              ...
              <div class="card-footer">
                <button type="submit" id="update_admin" class="btn btn-primary"><i class="fa fa-check-circle"></i> Update Admin</button>
              </div>
            </form>
