...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($con, "UPDATE expense SET expense_name='$expense_name',expense_note='$expense_note',expense_amount='$expense_amount',expense_time='$expense_time',expense_date='$expense_date',shop_id='$shop_id' WHERE expense_id='$expense_id'")) {
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_expense.php">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="expense_id" class="form-control"
                                           id="exampleInputexpenseId"
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_expense" class=" btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Expense
                                </button>
                            </div>
                        </form>
