...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = mysqli_query($con, "Update customers SET customer_name='$customer_name',customer_email='$customer_email',customer_cell='$customer_phone',customer_address='$customer_address',shop_id='$shop_id' WHERE customer_id='$customer_id'");
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_customer.php">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_customer" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Customer
                                </button>
                            </div>
                        </form>
