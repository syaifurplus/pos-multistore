...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($status == "OK") {
        ...
        $sql = mysqli_query($con, "Update suppliers SET suppliers_name='$supplier_name',suppliers_contact_person='$supplier_contact_person',suppliers_email='$supplier_email',suppliers_cell='$supplier_phone',suppliers_address='$supplier_address',shop_id='$shop_id' WHERE suppliers_id='$supplier_id'");
                    ...
                    <div class="card">
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_supplier.php">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_supplier" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Supplier
                                </button>
                            </div>
                        </form>
