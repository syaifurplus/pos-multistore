...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = mysqli_query($con, "UPDATE product_category SET product_category_name='$product_category_name',shop_id='$shop_id' WHERE product_category_id='$product_category_id'");
                        ...
                        <form role="form" id="quickForm" method="post" action="edit_category.php">
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_category" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Category
                                </button>
                            </div>
                        </form>
