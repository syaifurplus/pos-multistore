                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="form-group">
                                    ...
                                    <form action="expense_report.php" id="myform" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputCategory">Select Shop</label>
                                        <select class="form-control" name="shop_id"  onchange="change()" id="inputShopId">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM expense WHERE shop_id='$shop_id' AND owner_id='$owner_id' ORDER BY expense_id DESC";

                                    $total_expense = getTotalExpenseByShop($shop_id);
