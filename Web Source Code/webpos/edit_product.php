...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (!empty($getid)) {
        ...
        //call function
        $shop_name = shopNameById($row['shop_id']);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($con, "UPDATE products SET product_name='$product_name',product_code='$product_code',product_category_id='$product_category_id',product_description='$product_description',product_sell_price='$product_sell_price',product_weight='$product_weight',product_weight_unit_id='$product_weight_unit_id',product_supplier_id='$product_supplier_id',product_image='$newfilename',product_stock='$product_stock',cgst='$cgst',sgst='$sgst',cess='$cess',shop_id='$shop_id' WHERE product_id='$product_id'")) {
                        ...
                        <form enctype="multipart/form-data" role="form" id="quickForm" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_category_id"
                                            ...
                                            <?php
                                            include('db_connect.php');
                                            $result = mysqli_query($con, "SELECT * FROM product_category WHERE owner_id='$owner_id'");
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="product_supplier_id">
                                                ...
                                                $result = mysqli_query($con, "SELECT * FROM suppliers WHERE owner_id='$owner_id'");
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="product_image" class="form-control"
                                               id="exampleInputPrice"
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputStock">Tax (%)</label>
                                        <input type="number" name="tax" class="form-control" id="exampleInputStock"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputShop">Shop Name</label>
                                            <select class="form-control" name="shop_id" id="exampleInputShop">
                                                <?php echo "<option value='" . $row['shop_id'] . "'>" . $shop_name . "</option>"; ?>
                            ...
                            <div class="card-footer">
                                <button type="submit" id="update_product" class="btn btn-primary"><i
                                            class="fa fa-check-circle"></i> Update Product
                                </button>
                            </div>
                        </form>
