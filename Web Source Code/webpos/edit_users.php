...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = mysqli_query($con, "Update users SET name='$user_name',email='$user_email',cell='$user_phone',password='$user_password',user_type='$user_type',shop_id='$shop_id' WHERE id='$user_id'");
