...
<div id="page-wrap">
    ...
    <div id="customer">
        ...
        <table id="meta2">
            ...
            <tr>
                ...
                <td>
                    <div class="due"><img alt='testing'
                                          src='plugins/barcode/barcode.php?codetype=Code128&size=50&text=<?php echo $getid ?>&print=true'/>
                    </div>
                </td>
        ...
        <table id="meta">
            ...
            <tr>
                ...
                <td>
                    <p id="date"><?php echo $data['order_time'] . ', ' . date('d F, Y', strtotime($data['order_date'])) ?></p>
                </td>
            </tr>
            <tr>
    ...
    <table id="items">
        ...
        <tr>
            ...
            <td class="total-value">
                <div id="subtotal"><?php echo getCurrency() . ' ' . number_format($data['tax'],2) ?></div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="total-value balance">
                <div class="due"><?php
                    ...
                    echo "<b>" . getCurrency() . ' ';
                    echo number_format($final_price,2) ?></b></div>
            </td>
        </tr>
