...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM products where product_code='$product_code' and owner_id='$owner_id'");
    ...
    if ($num_rows > 0) {
        ...
        if (mysqli_query($con, "INSERT INTO products (`product_name`,`product_code`,`product_category_id`,`product_description`,`product_sell_price`,`product_weight`,`product_weight_unit_id`,`product_supplier_id`,`product_image`,`product_stock`,`shop_id`,`owner_id`,`tax`) VALUE ('$product_name','$product_code','$product_category_id','$product_description','$product_sell_price','$product_weight','$product_weight_unit_id','$product_supplier_id','$newfilename','$product_stock','$shop_id','$owner_id','$tax')")) {
            echo '<script type="text/javascript">';
            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <form enctype="multipart/form-data" role="form" id="quickForm" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="product_description" class="form-control"
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" id="add_product" class="btn btn-primary"><i
                                    class="fa fa-check-circle"></i> Add product
                        </button>
                    </div>
                    </form>
