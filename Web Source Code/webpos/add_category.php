...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = mysqli_query($con, "SELECT * FROM product_category WHERE product_category_name='$product_category_name' AND shop_id='$shop_id' AND owner_id='$owner_id'");
    ...
    if ($num_rows > 0) {
        ...
        if (mysqli_query($con, "INSERT INTO product_category (`product_category_name`,`shop_id`,`owner_id`) VALUE ('$product_category_name','$shop_id','$owner_id')")) {
            echo '<script type="text/javascript">';
