...
if ($_SERVER['REQUEST_METHOD'] == 'GET' ){
  ...
  if(strlen($search_text)>1)
  {
        ...
        $query = "SELECT * FROM products WHERE shop_id='$shop_id' AND (product_name LIKE '%$search_text%' OR product_code LIKE '%$search_text%') ORDER BY product_id DESC";
  ...
  else
  {
      ...
      $query = "SELECT * FROM products WHERE shop_id='$shop_id' ORDER BY product_id DESC";
